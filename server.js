...
app.post('/api/google/import',async(req,res)=>{
  try{
    ...
    for(const e of evs){
      ...
      const body={
        summary:`${e.meal[0].toUpperCase()+e.meal.slice(1)} — ${e.items.slice(0,3).join(', ')}`,
